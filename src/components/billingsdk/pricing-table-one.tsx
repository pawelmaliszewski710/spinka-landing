...
export function PricingTableOne({
  ...
  return (
    <section className={cn(sectionVariants({ size, theme }), className)}>
      ...
      <div className={cn("relative container mx-auto px-4", "md:px-6")}>
              ...
              >
                ...
                <div className="flex h-full flex-col justify-between gap-10">
                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    >
                      {theme === "classic" && plan.highlight && !plan.disabled && (
                        <Zap className="mr-1 h-4 w-4" />
                      )}
                      {plan.buttonText}
                      {theme === "classic" && !plan.disabled && (
                    ...
                    {plan.disabled && plan.disabledMessage && (
